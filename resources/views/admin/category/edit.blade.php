    ...
    <div class="row gutters">
        <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form id="steps-form" method="POST" action="{{ route('category.update', $category->id) }}" enctype="multipart/form-data">
                        @csrf
                        {{ method_field('PUT') }}
                        <div id="steps-div">
                            ...
                            <section>
                                ...
                                <div class="row gutters">
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                        <div class="field-wrapper">
                                            <input type="text" name="category_name" value="{{ $category->name }}" placeholder="Kategori Adını Giriniz..">

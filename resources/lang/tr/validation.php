...
return array(
    ...
    'custom' => [
        ...
        'tr_price' => [
            ...
            'numeric' => 'TR Fiyat alanı sadece rakam olabilir.'
        ],
        'usd_price' => [            
            'numeric' => 'USD Fiyat alanı sadece rakam olabilir.'
        ],
        'euro_price' => [            
            'numeric' => 'EUR Fiyat alanı sadece rakam olabilir.'
        ],
        'link' => [
            'required' => 'Link boş bırakılamaz.'
        ],
        'cover_image' => [
            'required' => 'Öne çıkan resim boş bırakılamaz.'
        ],
        'category_name' => [
